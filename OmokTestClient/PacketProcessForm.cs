...
namespace csharp_test_client
{
    public partial class mainForm
    {
        ...
        void SetPacketHandler()
        {
            ...
            PacketFuncDic.Add(PACKET_ID.PK_LOGIN_RES, PacketProcess_LoginResponse);
            PacketFuncDic.Add(PACKET_ID.PK_ENTER_ROOM_RES, PacketProcess_RoomEnterResponse);
            //PacketFuncDic.Add(PACKET_ID.ROOM_USER_LIST_NTF, PacketProcess_RoomUserListNotify);
            PacketFuncDic.Add(PACKET_ID.PK_NEW_USER_ENTER_ROOM_NTF, PacketProcess_RoomNewUserNotify);
            PacketFuncDic.Add(PACKET_ID.PK_LEAVE_ROOM_RES, PacketProcess_RoomLeaveResponse);
            PacketFuncDic.Add(PACKET_ID.PK_USER_LEAVE_ROOM_NTF, PacketProcess_RoomLeaveUserNotify);
            PacketFuncDic.Add(PACKET_ID.PK_CHAT_ROOM_RES, PacketProcess_RoomChatResponse);            
            PacketFuncDic.Add(PACKET_ID.PK_CHAT_ROOM_NTF, PacketProcess_RoomChatNotify);
        ...
        void PacketProcess_RoomChatResponse(byte[] bodyData)
        {
            ...
            var msg = $"내가 요청한 방 채팅 요청 결과:  {(ERROR_CODE)responsePkt.Result}";

...
namespace csharp_test_client
{
    public partial class mainForm : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PostSendPacket(PACKET_ID.PK_LOGIN_REQ, loginReq.ToBytes());            
        ...
        private void btn_RoomEnter_Click(object sender, EventArgs e)
        {
            ...
            PostSendPacket(PACKET_ID.PK_ENTER_ROOM_REQ, requestPkt.ToBytes());
            DevLog.Write($"방 입장 요청:  {textBoxRoomNumber.Text} 번");
        }

        private void btn_RoomLeave_Click(object sender, EventArgs e)
        {
            PostSendPacket(PACKET_ID.PK_LEAVE_ROOM_REQ,  null);
            DevLog.Write($"방 입장 요청:  {textBoxRoomNumber.Text} 번");
        }
        ...
        private void btnRoomChat_Click(object sender, EventArgs e)
        {
            ...
            PostSendPacket(PACKET_ID.PK_CHAT_ROOM_REQ, requestPkt.ToBytes());


            AddRoomChatMessageList(textBoxUserID.Text, textBoxRoomSendMsg.Text);
